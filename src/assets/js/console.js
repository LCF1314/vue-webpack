...
// 添加调试不同的输出样式
console.todo = function() {
    _log.call(console, '%c%s%s%s', 'color: yellow; background-color: black;', '–', [].slice.call(arguments).join(' '), '–')
}
/* console.todo = (msg) => {
